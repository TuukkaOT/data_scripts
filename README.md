...
*Necessary Python libraries can be installed by running "pip install -r requirements.txt" in your environment. You might want to create, e.g., a conda environment (I have used Python version 3.10.9) especially as the scripts require older versions of some packages.*
